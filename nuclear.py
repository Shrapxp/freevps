...
def show_help(message):
    response = """𝐈 𝐊𝐍𝐎𝐖 𝐘𝐎𝐔 𝐂𝐎𝐌𝐌𝐀𝐍𝐃 𝐈𝐒 --> 𝐒𝟒 \n𝐁𝐔𝐓 𝐇𝐈𝐒 𝐁𝐎𝐓𝐒 𝐅𝐀𝐓𝐇𝐄𝐑 @GOKU_VAMPIRE \n𝐎𝐖𝐍𝐄𝐑 𝐎𝐅 NNUCLEAR_OP
"""
    keyboard = telebot.types.InlineKeyboardMarkup()
    keyboard.row(
        telebot.types.InlineKeyboardButton('Updates', url='https://t.me/NNUCLEAR_OP'),
        telebot.types.InlineKeyboardButton('Support', url='https://t.me/+8d_8xWZiin40YjM9')
    )
